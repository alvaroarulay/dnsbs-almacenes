            ...
            <div class="row mb-3">
                ...
                <div class="text-end col-md-8">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" v-model="buscar" @keyup.enter="obtenerProvedores(1, buscar.toUpperCase(), criterio)"
                               placeholder="Buscar..." aria-label="Buscar" aria-describedby="button-addon2">
                        <button class="btn btn-info btn-sm" @click="obtenerProvedores(1, buscar.toUpperCase(), criterio)">
