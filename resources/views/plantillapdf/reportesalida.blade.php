...
<body>
    <header>
        <div style="width: 19.59cm; height: 5cm;">
            <table>
                <tr>
                    <td>
                    ...
                    <td>
                        <div style="width: 8.5cm; height: 1.5cm;">
                    ...
                    <td>
                        <div style="width: 4cm; height: 1cm;">
							...
							<p style="font-size: xx-small; margin: 0.1cm;">{{$resp->nomper}}</p>
							<p style="font-size: xx-small; margin: 0.1cm;">{{$resp->cargo}}</p>
                        </div>
                    </td>
                </tr>
            </table>
       ...
       <table id="customers">
            <thead>
                <tr style="border: 1px solid ;">
					...
					<th style="width: 5.5cm; text-align:center">DESCRIPCIÓN</th>
            ...
            <tfoot>
				<tr >
					<td style="font-size: x-small; text-align: right;" colspan="8" >Cantidad: {{$datos->count()}}</td>
				</tr>
				<tr >
					<td style="font-size: x-small; text-align: right;" colspan="8" >Total: {{number_format($total, 2, ',', '.')}} Bs. </td>
				</tr>
			</tfoot>
        </table>
    </main>
